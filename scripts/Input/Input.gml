...
{
	if (_is_host && _is_local) // Grab HOST INPUTS
	{
	//Directions inputs HOST
	...
	if (!_is_host && _is_local) // Are we the CLIENT?
	{
		// Directional Inputs
